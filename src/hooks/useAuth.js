...
export const useAuth = ({ middleware, redirectIfAuthenticated}) => {
    //hacemos uso de la funcion getCategories, para wue cuando se haga login mandar a llamarla
    // const {getCategories} = useAmorPorTi()
    ...
    const { data: user, error, mutate } = useSWR(
        ...
        () =>
            ...
            // {
            //     refreshInterval: 1000, // Establece el intervalo de actualización a 1000 milisegundos (1 segundo)
            // },   
    )
    // console.log(user);
